...
export default function NotebookMenu(props: NotebookMenuProps) {
  ...
  const handleAddNotebook = debounce(() => {
    const notebookIndex = allNotebookData[0].name === 'Please Add Notebook' ? 0 : allNotebookData.length
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          ...
          <IconButton color="primary" onClick={handleDrawerClose} sx={{ marginRight: '-15px' }}>
