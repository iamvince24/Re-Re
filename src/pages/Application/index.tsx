      ...
      <ThemeProvider theme={theme}>
        <ApplicationContainer component="section">
          <Drawer
            ...
            open={isSidebarOpen}
          >
            <NotebookMenu dispatch={dispatch} theme={theme} uid={uid} />
          </Drawer>
          ...
          <AppBar
            ...
            style={{
              ...
              borderLeft: isSidebarOpen ? `0.5px solid ${theme.palette.dividerBorder.main}` : 'none',
            }}
          >
            {isGanttMode ? (
              <GanttChartMode dispatch={dispatch} theme={theme} notebookData={allNotebookData} />
            ) : (
